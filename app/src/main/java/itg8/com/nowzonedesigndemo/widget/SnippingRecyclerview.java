...
public class SnippingRecyclerview extends RecyclerView {
    ...
    public SnippingRecyclerview(Context context) {
        this(context, null);
    }

    public SnippingRecyclerview(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SnippingRecyclerview(Context context, AttributeSet attrs, int defStyleAttr) {
