...
import itg8.com.nowzonedesigndemo.widget.maditation.animation.AnimationUtils;
import itg8.com.nowzonedesigndemo.widget.maditation.animation.FloatProperty;
import itg8.com.nowzonedesigndemo.widget.maditation.animation.IntProperty;
...
public abstract class Sprite extends Drawable implements
    ...
    public void draw(Canvas canvas) {
        ...
        // these lines are used for the bouncesing animation
    ...
    public void drawForAnimation(Canvas canvas) {
        int tx = getTranslateX();
        tx = tx == 0 ? (int) (getBounds().width() * getTranslateXPercentage()) : tx;
        int ty = getTranslateY();
        ty = ty == 0 ? (int) (getBounds().height() * getTranslateYPercentage()) : ty;
